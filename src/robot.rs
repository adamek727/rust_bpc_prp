...
use crate::sensor_model;
use crate::sensor_model::SensorModel;

#[derive(Copy, Clone)]
pub enum RobotStateMachine {
    Initialization,
    CalibrationRotateLeft,
    CalibrationRotateRight,
    CalibrationCenter,
    LineFollowing,
    Fail,
    Custom,
...
impl RobotPhysicalConstrains {
    pub fn new(no_of_sensors: usize,
               ...
               steps_per_rotation: usize,
               microsteps_per_step: usize,
               sensor_range_mm: f32) -> RobotPhysicalConstrains {
    ...
    pub fn sensor_range_mm(&self) -> f32 { self.sensor_range_mm }
}
...
impl RobotStats {
    ...
    pub fn sensor_value_for_index(&self, sensor_index: usize) -> u16 { self.sensor_values[sensor_index] }
    pub fn sensor_values(&self) -> Vec<u16> { self.sensor_values.clone() }
    pub fn number_of_sensors(&self) -> usize { self.no_of_sensors }
